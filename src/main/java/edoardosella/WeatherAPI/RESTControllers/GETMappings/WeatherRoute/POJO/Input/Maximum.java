...
public class Maximum implements Serializable {
    ...
    private final static long serialVersionUID = -7756454322396930514L;
     ...
     * @param value
     */
    public Maximum(double value, String unit, long unitType) {
        super();
        this.value = value;
        this.unit = unit;
    ...
    public Maximum withUnitType(long unitType) {
        this.unitType = unitType;
        return this;
    }
